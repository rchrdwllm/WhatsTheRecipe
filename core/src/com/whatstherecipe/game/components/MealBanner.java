...
public class MealBanner {
    ...
    private void renderLabels() {
        ...
        Label yourMealLabel = new Label("Your meal...", CustomSkin.generateCustomLilitaOneFont(Colors.lightBrown, 80));
        ...
        Label instructionsLabel = new Label(
                "You've got x minutes to collect the required ingredients from the kitchen cabinets. Good luck!",
        ...
        mealDifficultyGroup.setPosition((this.kitchenScreen.game.V_WIDTH / 2) - (mealDifficultyGroup.getWidth() / 2),
